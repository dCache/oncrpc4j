...
public class jrpcgen {
    ...
    private static void dumpClientStubMethod(PrintWriter out, JrpcgenProcedureInfo proc, ClientMethodType methodType) {
        ...
        if (ClientMethodType.CALLBACK.equals(methodType)) {
            //add last argument - the callback handler
            if (PARAMS_VOID != paramsKind) {
                out.print(", ");
            }
        ...
        switch (methodType) {
            ...
            case FUTURE:
                ...
                break;
            case CALLBACK:
                out.println("        client.call(" + baseClassname + "." + proc.procedureId + ", " + xdrParamsName + ", completionHandler);");
                break;
            case ONE_WAY:
                out.println("        client.call(" + baseClassname + "." + proc.procedureId + ", " + xdrParamsName + ", (CompletionHandler) null);");
                break;
            default:
                throw new IllegalStateException("unhandled: "+methodType);
        }
